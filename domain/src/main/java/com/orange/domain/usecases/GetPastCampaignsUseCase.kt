...
class GetPastCampaignsUseCaseImpl(
    private val galleryRepository: CampaignsRepository
) : GetPastCampaignsUseCase {

    override fun getPastCampaigns(): Single<List<CampaignModel>> {
...
interface GetPastCampaignsUseCase {
    fun getPastCampaigns(): Single<List<CampaignModel>>
}
